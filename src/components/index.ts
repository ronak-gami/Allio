...
export { default as CustomFlatList } from './atoms/FlatList';
export { default as CustomModal } from './atoms/CustomModel';
export { default as CustomOnboarding } from './atoms/CustomOnboarding';
...
export { default as AccelometerCard } from './cards/accelometerCard';
